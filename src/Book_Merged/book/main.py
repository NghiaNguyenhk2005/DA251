...
def load_fonts():
    ...
    fonts = {}
    try:
        fonts['list'] = pygame.font.Font("Harmonic.ttf", 36)
        
        font_title_sizes = [42, 36, 32, 28, 24]

        fonts['title_options'] = {size: pygame.font.Font("Harmonic.ttf", size) for size in font_title_sizes}
        
        font_desc_sizes = [36, 32, 28, 24]
        # === SỬA LỖI TẠI ĐÂY ===
        # Phải dùng "Harmonic.ttf" cho description
        fonts['desc_options'] = {size: pygame.font.Font("Harmonic.ttf", size) for size in font_desc_sizes}
        
        fonts['page_count'] = pygame.font.Font("Harmonic.ttf", 28)
...
def load_images():
    ...
    images['closed_book_icon'] = pygame.image.load("brownbook.png").convert_alpha()
