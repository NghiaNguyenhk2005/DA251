...
def draw_inventory_icon(screen, mouse_pos):
    ...
    inventory_icon_sprite_sheet = pygame.image.load("src/assets/inventory/UI_Inventory_icon.png").convert_alpha()
...
def draw_inventory(screen, mouse_pos):
    ...
    # Load assets
    inventory_sprite_sheet = pygame.image.load("src/assets/inventory/UI Inventory.png").convert_alpha()
    border_sprite_sheet = pygame.image.load("src/assets/inventory/BlackGrey UI Border.png").convert_alpha()
    button_sprite_sheet = pygame.image.load("src/assets/inventory/UI Buttons.png").convert_alpha()
