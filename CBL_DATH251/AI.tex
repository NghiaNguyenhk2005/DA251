...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Đề xuất các công nghệ phù hợp cho phát triển ứng dụng.
        ...
        \item Hỗ trợ viết nháp cho một số đoạn mô tả kỹ thuật.
        ...
        \item Hỗ trợ thiết kế bối cảnh (backgrounds). Các hình ảnh này đã được nhóm phát triển tinh chỉnh và biên tập lại để đảm bảo tính thẩm mỹ và phong cách nghệ thuật đồng nhất của trò chơi.
        \item Hỗ trợ sửa lỗi và kiểm tra tính logic cho các đoạn mã do nhóm tự viết.
    \end{enumerate}
