...
Ngoài ra, PC cũng chính là nền tảng đội ngũ sử dụng để phát triển và chạy thử các bản thử nghiệm. Tập trung phát hành cho PC trước giúp giảm thiểu rủi ro, cho phép nhóm  dễ dàng điều chỉnh, tối ưu hóa và sửa lỗi trước khi phát hành chính thức.
...
Đây là bước tiếp theo để mở rộng thị trường sau khi bản PC đã ổn định. Nhóm sẽ tối ưu hóa giao diện và trải nghiệm người dùng để phù hợp với màn hình cảm ứng, đảm bảo game vẫn giữ được chiều sâu của thể loại trinh thám nhưng cũng dễ dàng tiếp cận trên nền tảng di động.